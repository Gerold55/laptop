...
minetest.register_node("laptop:monitor3_on", {
	...
	tiles = {
		"laptop_k_top.png^t_top.png^p_top.png^m_top.png",
		"laptop_laptop_laptop_laptop_laptop_k_bottom.png^t_bottom.png^p_bottom.png^m_bottom.png",
		"laptop_laptop_laptop_laptop_k_right.png^t_right.png^p_right.png^m_right.png",
		"laptop_laptop_laptop_k_left.png^t_left.png^p_left.png^m_left.png",
		"laptop_laptop_k_back.png^t_back.png^p_back.png^m_back.png",
		"laptop_k_front.png^t_front_on.png^p_front.png^m_front_on.png",
	},
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = 'facedir',
...
minetest.register_node("laptop:monitor3_off", {
    description = "MT Desktop vintage 3.0",
	tiles = {
		"laptop_laptop_laptop_laptop_laptop_laptop_k_top.png^t_top.png^p_top.png^m_top.png",
		"laptop_laptop_laptop_laptop_laptop_k_bottom.png^t_bottom.png^p_bottom.png^m_bottom.png",
		"laptop_laptop_laptop_laptop_k_right.png^t_right.png^p_right.png^m_right.png",
		"laptop_laptop_laptop_k_left.png^t_left.png^p_left.png^m_left.png",
		"laptop_laptop_k_back.png^t_back.png^p_back.png^m_back.png",
		"laptop_k_front.png^t_front.png^p_front.png^m_front.png",
	},
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = 'facedir',
...
minetest.register_node("laptop:laptop_open", {
	...
	tiles = {
		...
		"laptop_lap_base_open_bottom.png^lap_sc_open_bottom.png",
		"laptop_lap_base_open_right.png",
		"laptop_lap_base_open_left.png",
		"laptop_lap_base_open_back.png^lap_sc_open_back.png",
		"laptop_lap_base_open_front.png^lap_sc_open_front.png",
	},
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = 'facedir',
...
minetest.register_node("laptop:laptop_open_on", {
	...
	tiles = {
		...
		"laptop_lap_base_open_left.png",
		"laptop_lap_base_open_back.png^lap_sc_open_back.png",
		"laptop_lap_base_open_front.png^lap_sc_open_on_front.png",
	},
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = 'facedir',
