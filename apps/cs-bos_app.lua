local help_texts = {
	...
	DIR = "                     Display directory of current disk. DIR [hdd, fdd] displays directory of specified disk. DIR [filename] brings up info for specified file or files if using wild card *.",
